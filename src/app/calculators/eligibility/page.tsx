...
export const metadata = {
  title: 'Loan Eligibility Calculator | Borrowing Limit Checker | Whitestone',
  description: 'Check your maximum loan eligibility amount online. Calculate your monthly installment paying capacity based on income, location, and existing debts.',
};

export default function EligibilityCalcPage() {
  return (
    <div className="flex flex-col w-full bg-slate-50 min-h-screen pb-24">
      ...
      <section className="relative pt-8 lg:pt-12 pb-12 bg-gradient-to-br from-slate-50 to-blue-50/20 text-center overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 flex flex-col gap-4 relative z-10">
          <span className="text-xs font-extrabold uppercase tracking-widest text-[#00A86B] font-poppins">Pre-Qualification</span>
      ...
      <section className="max-w-4xl mx-auto px-6 md:px-8 mt-16 flex flex-col gap-6">
        <h2 className="text-lg font-bold text-slate-800 font-poppins">Understanding FOIR & Loan Eligibility</h2>
        <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-100 shadow-xs flex flex-col gap-4 text-xs md:text-sm text-slate-600 leading-relaxed font-semibold">
          ...
          <div className="p-4 bg-slate-50 border border-slate-200 rounded-xl text-center">
            <span className="font-bold text-slate-800 font-poppins block text-xs tracking-wider uppercase mb-1">FOIR Calculation Formula</span>
            <span className="text-sm md:text-base font-bold text-[#0B4F9C] font-dmsans">
              FOIR = (Total Existing Monthly Obligations / Net Monthly Income) x 100
            </span>
          </div>
          <p className="mt-2">
