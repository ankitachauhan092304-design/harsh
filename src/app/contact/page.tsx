        ...
        <div className="lg:col-span-5 flex flex-col gap-8">
          <div className="bg-white p-6 md:p-8 rounded-3xl border border-slate-100 shadow-xs flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-5 text-sm text-slate-600 font-semibold">
              ...
              <div className="flex items-start gap-3">
                <Globe size={20} className="text-[#00A86B] shrink-0 mt-0.5" />
                <div className="flex flex-col">
                  <span className="text-slate-800 font-bold">Service Area</span>
                  <span className="text-xs text-slate-500 mt-0.5">Gujarat (Ahmedabad, Surat, Vadodara, Rajkot, etc.)</span>
                </div>
              </div>
            </div>

            <div className="mt-2 flex flex-col sm:flex-row gap-3 border-t border-slate-100 pt-5">
              <a
                href="https://maps.google.com/?q=Whitestone+Fincorp+Opp.+ADC+Bank,+Rakhial,+Ahmedabad"
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl border border-slate-200 hover:bg-slate-50 text-slate-700 font-bold text-xs transition-all duration-300 text-center"
              >
                <svg className="w-4 h-4 text-[#4285F4] fill-current shrink-0" viewBox="0 0 24 24">
                  <path d="M12.24 10.285V14.4h6.887c-.648 2.41-2.519 4.113-6.886 4.113-4.907 0-8.905-4.024-8.905-9s3.998-9 8.905-9c2.272 0 4.187.844 5.635 2.208l3.19-3.19C18.66.796 15.747 0 12.24 0 5.481 0 0 5.373 0 12s5.481 12 12.24 12c6.91 0 11.52-4.86 11.52-11.727 0-.788-.085-1.39-.193-1.988H12.24z"/>
                </svg>
                View us on Google
              </a>
              <a
                href="https://wa.me/919824975488?text=Hello%2C%20I%20have%20a%20question%20about%20your%20services."
                target="_blank"
                rel="noopener noreferrer"
                className="flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#25D366] hover:bg-[#22c55e] text-white font-bold text-xs shadow-sm transition-all duration-300 text-center"
              >
          ...
          {/* Embedded Google Map */}
          <div className="h-[260px] rounded-3xl overflow-hidden border border-slate-200 shadow-sm">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3672.2356515867145!2d72.617478!3d23.0245645!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x395e86095be91c49%3A0xe54d24599c2db9c6!2sWhitestone%20Fincorp!5e0!3m2!1sen!2sin!4v1717320000000!5m2!1sen!2sin"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              ...
              title="Whitestone Fincorp Office Location"
            />
          </div>
        </div>
