...
for (const filePath of htmlFiles) {
  ...
  // 3. Remove Next.js React hydration scripts for public pages to avoid 404s on GitHub Pages custom domains (EXCEPT admin.html which requires React JS bundle)
